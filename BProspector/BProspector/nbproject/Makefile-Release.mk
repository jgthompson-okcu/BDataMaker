...
${OBJECTDIR}/_ext/1946407073/Includes.o: ../../Prospectorc++/Prospector/src/Includes.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1946407073/Includes.o ../../Prospectorc++/Prospector/src/Includes.cpp

${OBJECTDIR}/_ext/1946407073/Main.cpp.o: ../../Prospectorc++/Prospector/src/Main.cpp.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1946407073
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1946407073/Main.cpp.o ../../Prospectorc++/Prospector/src/Main.cpp.cpp

${OBJECTDIR}/_ext/1946407073/MyClass.o: ../../Prospectorc++/Prospector/src/MyClass.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1946407073
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1946407073/MyClass.o ../../Prospectorc++/Prospector/src/MyClass.cpp

${OBJECTDIR}/_ext/1946407073/Prospect.o: ../../Prospectorc++/Prospector/src/Prospect.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1946407073
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1946407073/Prospect.o ../../Prospectorc++/Prospector/src/Prospect.cpp

${OBJECTDIR}/_ext/1946407073/Tokenize.o: ../../Prospectorc++/Prospector/src/Tokenize.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1946407073
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1946407073/Tokenize.o ../../Prospectorc++/Prospector/src/Tokenize.cpp
